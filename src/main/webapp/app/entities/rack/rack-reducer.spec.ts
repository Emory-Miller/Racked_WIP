...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './rack.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RACK_LIST actions', async () => {
    ...
    it('dispatches FETCH_RACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RACK actions', async () => {
      const expectedActions = [
        {
