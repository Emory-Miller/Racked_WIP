...
class ReviewResourceIT {
    ...
    void createReview() throws Exception {
        ...
        assertThat(testReview.getAmenities()).isEqualTo(DEFAULT_AMENITIES);
    ...
    void putExistingReview() throws Exception {
        ...
        updatedReview.starRating(UPDATED_STAR_RATING).rackSize(UPDATED_RACK_SIZE).amenities(UPDATED_AMENITIES).comments(UPDATED_COMMENTS);
        ...
        assertThat(testReview.getAmenities()).isEqualTo(UPDATED_AMENITIES);
    ...
    void partialUpdateReviewWithPatch() throws Exception {
        ...
        partialUpdatedReview.amenities(UPDATED_AMENITIES).comments(UPDATED_COMMENTS);
